...
public enum BookmarkBufferState {
    case NoUnmergedRemoteChanges
    case UnmergedRemoteChanges
}

public protocol BufferedBookmarks: class {
    func bufferState() -> Deferred<Maybe<BookmarkBufferState>>
}
