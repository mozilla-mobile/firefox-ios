...
public struct AddressToolbarConfiguration {
    ...
    public let locationViewConfiguration: LocationViewConfiguration
    ...
    public let leadingPageActions: [ToolbarElement]

    /// Trailing page actions of the address toolbar
    public let trailingPageActions: [ToolbarElement]
