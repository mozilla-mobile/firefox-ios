...
public struct NavigationToolbarConfiguration {
    ...
    // Whether the toolbar is translucent
    let isTranslucencyEnabled: Bool

    let uxConfiguration: NavigationToolbarUXConfiguration
    ...
    public init(actions: [ToolbarElement],
                ...
                uxConfiguration: NavigationToolbarUXConfiguration) {
        self.actions = actions
        self.shouldDisplayBorder = shouldDisplayBorder
        self.isTranslucencyEnabled = isTranslucencyEnabled
