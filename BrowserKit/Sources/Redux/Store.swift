...
public final class Store<State: StateType & Sendable>: DefaultDispatchStore {
    ...
    /// Legacy method to dispatch actions to the global store. Eventually will be replaced by `ModernAction`.
    ...
    /// New method to dispatch actions to the global store. Will eventually fully replace the legacy `Action` type.
