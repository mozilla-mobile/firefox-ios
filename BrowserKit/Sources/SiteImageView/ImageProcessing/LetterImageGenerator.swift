...
final class DefaultLetterImageGenerator: LetterImageGenerator, @unchecked Sendable {
    ...
    private let themeManagerProvider: () -> ThemeManager

    init(themeManager: @autoclosure @escaping () -> ThemeManager = AppContainer.shared.resolve(),
         logger: Logger = DefaultLogger.shared) {
        self.themeManagerProvider = themeManager
        self.logger = logger
    }
