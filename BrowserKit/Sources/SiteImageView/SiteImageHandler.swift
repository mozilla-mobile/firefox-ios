...
public actor DefaultSiteImageHandler: SiteImageHandler {
    ...
    nonisolated public func cacheFaviconURL(siteURL: URL?, faviconURL: URL?) {
    ...
    public nonisolated func clearAllCaches() {
    ...
    private nonisolated func generateCacheKey(siteURL: URL?,
                                              faviconURL: URL? = nil,
    ...
    private nonisolated func generateDomainURL(siteURL: URL) -> ImageDomain {
