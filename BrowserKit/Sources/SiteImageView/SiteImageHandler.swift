...
public class DefaultSiteImageHandler: SiteImageHandler {
    ...
    /// URLs, download images, etc. Since that's a large architectural change, for now lets use a static queue so we can prevent
    /// too many duplicate calls to remotely fetching URLs and images. (FXIOS-9830, revised FXIOS-9427 bugfix)
