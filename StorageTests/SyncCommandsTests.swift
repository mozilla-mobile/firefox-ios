...
class SyncCommandsTests: XCTestCase {
    ...
    func testInsertWithNoURLOrTitle() {
        ...
        let e = self.expectation(withDescription: "Insert.")
    ...
    func testGetForAllClients() {
        ...
        let b = self.expectation(withDescription: "Get for invalid client.")
    ...
    func testDeleteForValidClient() {
        ...
        let a = self.expectation(withDescription: "delete for client.")
        let b = self.expectation(withDescription: "Get for deleted client.")
        let c = self.expectation(withDescription: "Get for not deleted client.")
        clientsAndTabs.insertCommands(syncCommands, forClients: clients).upon {
            XCTAssertTrue($0.isSuccess)
            XCTAssertEqual(12, $0.successValue!)
    ...
    func testDeleteForAllClients() {
        ...
        let a = self.expectation(withDescription: "Wipe for all clients.")
        let b = self.expectation(withDescription: "Get for clients.")
        clientsAndTabs.insertCommands(syncCommands, forClients: clients).upon {
            XCTAssertTrue($0.isSuccess)
            XCTAssertEqual(12, $0.successValue!)
