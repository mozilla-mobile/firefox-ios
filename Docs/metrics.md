...
| default_browser_card.go_to_settings_pressed |[counter](https://mozilla.github.io/glean/book/user/metrics/counter.html) |Counts the number of times the Go To Settings button on default browser card is clicked.  |[1](https://bugzilla.mozilla.org/show_bug.cgi?id=1644846)||2021-07-01 |
