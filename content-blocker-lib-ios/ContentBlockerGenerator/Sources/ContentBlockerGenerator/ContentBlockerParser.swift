...
class ContentBlockerParser {
    ...
    func handleCategoryItem(_ categoryItem: Any, action: Action) -> [String] {
    ...
    func parseBlocklist(json: [String: Any], action: Action, categoryTitle: CategoryTitle) -> [String] {
    ...
    func parseFingerprintingList(json: [String]) -> [String] {
        var result = [String]()
        for domain in json {
    ...
    private func buildOutputLine(urlFilter: String, unlessDomain: String, action: Action) -> String {
