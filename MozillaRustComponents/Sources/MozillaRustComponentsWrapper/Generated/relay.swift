...
public convenience init(serverUrl: String, authToken: String?)throws  {
    ...
    uniffi_relay_fn_constructor_relayclient_new(
        ...
        FfiConverterOptionString.lower(authToken),uniffiCallStatus
    )
}
...
open func createAddress(description: String, generatedFor: String, usedOn: String)throws  -> RelayAddress  {
    ...
    uniffi_relay_fn_method_relayclient_create_address(
        ...
        FfiConverterString.lower(usedOn),uniffiCallStatus
    )
})
}
...
open func shouldShowRelay(host: String, domain: String, isRelayUser: Bool) -> Bool  {
    ...
    uniffi_relay_fn_method_relayremotesettingsclient_should_show_relay(
        ...
        FfiConverterBool.lower(isRelayUser),uniffiCallStatus
    )
})
}
...
public 
enum RelayApiError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_relay_checksum_method_relayclient_accept_terms() != 27006) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_method_relayclient_create_address() != 37961) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_method_relayclient_fetch_addresses() != 25647) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_method_relayclient_fetch_profile() != 44087) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_method_relayremotesettingsclient_should_show_relay() != 52714) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_constructor_relayclient_new() != 12207) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_relay_checksum_constructor_relayremotesettingsclient_new() != 46219) {
        return InitializationResult.apiChecksumMismatch
    }
