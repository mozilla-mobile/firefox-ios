 ...
 */
public 
enum CrashTestError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
public func triggerRustAbort()  {try! rustCall() {
        uniffiCallStatus in
    uniffi_crashtest_fn_func_trigger_rust_abort(uniffiCallStatus
    )
}
}
/**
...
public func triggerRustError()throws   {try rustCallWithError(FfiConverterTypeCrashTestError_lift) {
        uniffiCallStatus in
    uniffi_crashtest_fn_func_trigger_rust_error(uniffiCallStatus
    )
}
}
/**
...
public func triggerRustPanic()  {try! rustCall() {
        uniffiCallStatus in
    uniffi_crashtest_fn_func_trigger_rust_panic(uniffiCallStatus
    )
}
}
