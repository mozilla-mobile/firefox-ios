...
class HexExtensionsTests: XCTestCase {
    ...
    func testHexDecodedData() {
        XCTAssertEqual("48656c6c6f2c20776f726c6421".hexDecodedData, "Hello, world!".dataUsingEncoding(String.Encoding.utf8))
        XCTAssertEqual("48656c6c6f2c20776f726c642121".hexDecodedData, "Hello, world!!".dataUsingEncoding(String.Encoding.utf8))
    }
