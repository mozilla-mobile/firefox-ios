...
@class Leanplum_AsyncReadPacket;
@class Leanplum_AsyncWritePacket;

extern NSString *const Leanplum_AsyncSocketException;
extern NSString *const Leanplum_AsyncSocketErrorDomain;

enum Leanplum_AsyncSocketError
{
...
typedef enum Leanplum_AsyncSocketError AsyncSocketError;

@interface NSObject (Leanplum_AsyncSocketDelegate)
 ...
 **/
- (void)onSocket:(Leanplum_AsyncSocket *)sock didAcceptNewSocket:(Leanplum_AsyncSocket *)newSocket;

/**
 * Called when a new socket is spawned to handle a connection.  This method should return the run-loop of the
 * thread on which the new socket and its delegate should operate. If omitted, [NSRunLoop currentRunLoop] is used.
 **/
- (NSRunLoop *)onSocket:(Leanplum_AsyncSocket *)sock wantsRunLoopForNewSocket:(Leanplum_AsyncSocket *)newSocket;
 ...
 **/
- (BOOL)onSocketWillConnect:(Leanplum_AsyncSocket *)sock;
 ...
 **/
- (void)onSocket:(Leanplum_AsyncSocket *)sock didReadPartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
 **/
- (void)onSocket:(Leanplum_AsyncSocket *)sock didWritePartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
 ...
 **/
- (NSTimeInterval)onSocket:(Leanplum_AsyncSocket *)sock
 ...
 **/
- (void)onSocketDidSecure:(Leanplum_AsyncSocket *)sock;
