    ...
    var body: some View {
        VStack {
            HStack(alignment: .top, spacing: 8.0) {
                ImageButtonWithLabel(action: .search)
                ImageButtonWithLabel(action: .privateSearch)
            }
            HStack(alignment: .top, spacing: 8.0) {
                ImageButtonWithLabel(action: .copiedLink)
                ImageButtonWithLabel(action: .closePrivateTabs)
            }
        }
        .padding(10.0)
