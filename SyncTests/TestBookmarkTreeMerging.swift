...
class MockUploader {
    ...
    func doUpload(_ recs: [Record<BookmarkBasePayload>], lastTimestamp: Timestamp?, onUpload: (POSTResult, Timestamp) -> DeferredTimestamp) -> DeferredTimestamp {
        var success: [GUID] = []
        recs.forEach { rec in
...
class TestBookmarkTreeMerging: FailFastTestCase {
    ...
    fileprivate func getBrowserDB(_ name: String) -> BrowserDB? {
