...
class MockSyncableHistory {
    ...
    fileprivate func placeForURL(_ url: String) -> DBPlace? {
...
class HistorySynchronizerTests: XCTestCase {
    fileprivate func applyRecords(_ records: [Record<HistoryPayload>], toStorage storage: SyncableHistory & ResettableSyncStorage) -> (synchronizer: HistorySynchronizer, prefs: Prefs, scratchpad: Scratchpad) {
