...
class DomainAutocompleteTest: BaseTestCase {
    ...
    override func setUp() {
        ...
        if testWithDB.contains(key) {
            ...
            launchArguments = [LaunchArguments.SkipIntro, LaunchArguments.SkipWhatsNew, LaunchArguments.SkipETPCoverSheet, LaunchArguments.LoadDatabasePrefix + historyDB, "--Reset"]
        }
        super.setUp()
    }
