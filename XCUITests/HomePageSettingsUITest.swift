...
class HomePageSettingsUITests: BaseTestCase {
    ...
    override func setUp() {
        ...
        if testWithDB.contains(key) {
            ...
            launchArguments = [LaunchArguments.SkipIntro, LaunchArguments.SkipWhatsNew, LaunchArguments.SkipETPCoverSheet, LaunchArguments.LoadDatabasePrefix + prefilledTopSites, "--Reset"]
        }
        super.setUp()
    }
