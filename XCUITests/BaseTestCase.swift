...
class BaseTestCase: XCTestCase {
    ...
    var launchArguments = [LaunchArguments.ClearProfile, LaunchArguments.SkipIntro, LaunchArguments.SkipWhatsNew, LaunchArguments.SkipETPCoverSheet, LaunchArguments.StageServer, LaunchArguments.SkipDefaultBrowserOnboarding, LaunchArguments.DeviceName, "\(LaunchArguments.ServerPort)\(serverPort)", "--Reset"]
