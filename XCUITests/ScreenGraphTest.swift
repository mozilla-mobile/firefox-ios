...
class ScreenGraphTest: XCTestCase {
    ...
    override func setUp() {
        ...
        app.terminate()
        app.launchArguments = [LaunchArguments.Test, LaunchArguments.ClearProfile, LaunchArguments.SkipIntro, LaunchArguments.SkipWhatsNew, LaunchArguments.SkipETPCoverSheet, "--Reset"]
        app.activate()
    }
}
