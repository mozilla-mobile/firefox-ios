...
class HistoryTests: BaseTestCase {
    ...
    override func setUp() {
        ...
        if testWithDB.contains(key) {
            ...
            launchArguments = [LaunchArguments.SkipIntro, LaunchArguments.SkipWhatsNew, LaunchArguments.SkipETPCoverSheet, LaunchArguments.SkipDefaultBrowserOnboarding, LaunchArguments.LoadDatabasePrefix + historyDB, "--Reset"]
        }
        super.setUp()
    }
