...
class NewTabSettingsTest: BaseTestCase {
    ...
    func testCheckNewTabSettingsByDefault() {
        ...
        Base.helper.waitForExistence(app.navigationBars["New Tab"])
    ...
    func testChangeNewTabSettingsShowBlankPage() {
        ...
        Base.helper.waitForNoExistence(app.collectionViews.cells["TopSitesCell"])
        Base.helper.waitForNoExistence(app.collectionViews.cells["TopSitesCell"].collectionViews.cells["youtube"])
        Base.helper.waitForNoExistence(app.staticTexts["Highlights"])
    }
    ...
    func testChangeNewTabSettingsShowFirefoxHome() {
        ...
        Base.helper.waitForExistence(app.buttons["urlBar-cancel"], timeout: 3)
    ...
    func testChangeNewTabSettingsShowCustomURL() {
        ...
        Base.helper.waitForValueContains(app.textFields["NewTabAsCustomURLTextField"], value: "mozilla")
