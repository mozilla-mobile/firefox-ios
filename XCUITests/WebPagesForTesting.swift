...
func registerHandlersForTestMethods(server: GCDWebServer) {
    ...
    ["test-window-opener", "test-password", "test-password-submit", "test-password-2", "test-password-submit-2", "test-example", "test-example-link", "test-mozilla-book", "test-mozilla-org",
