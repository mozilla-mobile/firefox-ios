...
LANGUAGES="af,ar,az,br,ca,cs,cy,de,dsb,en-US,eo,es,es-CL,es-ES,fa,fil,fr,ga-IE,gd,he,hi-IN,hsb,hu,id,is,it,ja,kab,ko,lo,nb-NO,nl,nn-NO,pl,pt-BR,pt-PT,ru,ses,sk,sl,sq,sv-SE,th,tr,uk,uz,zh-CN,zh-TW"
