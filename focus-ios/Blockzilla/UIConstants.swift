...
struct UIConstants {
    ...
    struct strings {
        ...
        static let externalAppLink = NSLocalizedString("ExternalAppLink.messageTitle", value: "Firefox Focus wants to open another App", comment: "Dialog title used for opening an external app from Focus")
        static let externalAppLinkWithAppName = NSLocalizedString("externalAppLinkWithAppName.messageTitle", value: "Firefox Focus wants to open %@", comment: "Dialog title used for opening an external app from Focus")
