...
struct UIConstants {
    ...
    struct strings {
        ...
        static let externalLinkTitle = NSLocalizedString("ExternalLink.messageTitle", value: "You are now leaving Firefox Focus.", comment: "Dialog title used for Maps/App Store links. Test page: https://people-mozilla.org/~bnicholson/test/schemes.html")
