...
struct UIConstants {
    ...
    struct strings {
        ...
        static let autocompleteAddCustomUrlPlaceholder = NSLocalizedString("Autocomplete.addCustomUrlPlaceholder", value: "Paste or enter URL", comment: "Watermark for the input field to add a custom URL")
