...
public class EngagedBeforeVerifiedState: ReadyForKeys {
    ...
    let knownUnverifiedAt: UInt64
    let lastNotifiedUserAt: UInt64

    public init(knownUnverifiedAt: UInt64, lastNotifiedUserAt: UInt64, sessionToken: NSData, keyFetchToken: NSData, unwrapkB: NSData) {
...
public class TokenKeysAndKeyPair: TokenAndKeys {
    ...
    let keyPairExpiresAt: UInt64

    init(sessionToken: NSData, kA: NSData, kB: NSData, keyPair: KeyPair, keyPairExpiresAt: UInt64) {
    ...
    func isKeyPairExpired(now: UInt64) -> Bool {
...
public class MarriedState: TokenKeysAndKeyPair {
    ...
    let certificateExpiresAt: UInt64

    init(sessionToken: NSData, kA: NSData, kB: NSData, keyPair: KeyPair, keyPairExpiresAt: UInt64, certificate: String, certificateExpiresAt: UInt64) {
    ...
    func isCertificateExpired(now: UInt64) -> Bool {
    ...
    public func generateAssertionForAudience(audience: String, now: UInt64) -> String {
