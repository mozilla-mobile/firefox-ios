...
public class SyncAuthState {
    ...
    typealias Cache = (token: TokenServerToken, forKey: NSData, expiresAt: UInt64)
    ...
    public func token(now: UInt64, canBeExpired: Bool) -> Deferred<Result<(token: TokenServerToken, forKey: NSData)>> {
