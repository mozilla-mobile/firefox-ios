...
struct MerinoTestData {
    ...
    private func mockFeedData(startingRank: Int64) -> [RecommendationDataItem] {
        let item1 = MozillaAppServices.RecommendationDataItem(
            ...
            title: "Snarls Barkley - iOS Team's Favourite Dog with Funny Toofs",
            excerpt: "He must be protec at all cost!",
            topic: Optional("food"),
            publisher: "Merino Mock Stories",
            isTimeSensitive: false,
            imageUrl: "https://i.pinimg.com/736x/bf/4a/8f/bf4a8f759c74d0af6c92da216c9eb807.jpg",
            iconUrl: nil,
