...
def test_sync_bookmark_from_desktop(tps, xcodebuild):
    tps.run('firefox-ios/Tests/SyncIntegrationTeststest_bookmark_desktop.js')
...
def test_sync_history_from_device(tps, xcodebuild):
    ...
    tps.run('firefox-ios/Tests/SyncIntegrationTests/test_history.js')

def test_sync_tabs_from_device(tps, xcodebuild):
    xcodebuild.test('XCUITests/IntegrationTests/testFxASyncTabs')
    tps.run('firefox-ios/Tests/SyncIntegrationTests/test_tabs.js')

def test_sync_history_from_desktop(tps, xcodebuild):
    tps.run('firefox-ios/Tests/SyncIntegrationTests/test_history_desktop.js')
