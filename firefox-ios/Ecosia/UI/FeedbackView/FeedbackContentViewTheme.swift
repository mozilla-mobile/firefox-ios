...
public struct FeedbackContentViewTheme: EcosiaThemeable {
    ...
    public init(from feedbackTheme: FeedbackTheme) {
        self.backgroundColor = feedbackTheme.backgroundColor
        self.sectionBackgroundColor = feedbackTheme.sectionBackgroundColor
        self.feedbackTypeListItemBackgroundColor = feedbackTheme.feedbackTypeListItemBackgroundColor
        self.textPrimaryColor = feedbackTheme.textPrimaryColor
        self.textSecondaryColor = feedbackTheme.textSecondaryColor
        self.buttonBackgroundColor = feedbackTheme.buttonBackgroundColor
        self.buttonDisabledBackgroundColor = feedbackTheme.buttonDisabledBackgroundColor
        self.brandPrimaryColor = feedbackTheme.brandPrimaryColor
        self.borderColor = feedbackTheme.borderColor
        self.borderWidth = feedbackTheme.borderWidth
    }
