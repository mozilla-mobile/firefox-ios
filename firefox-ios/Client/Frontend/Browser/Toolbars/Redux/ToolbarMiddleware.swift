...
final class ToolbarMiddleware: FeatureFlaggable {
        ...
        case GeneralBrowserMiddlewareActionType.browserDidLoad:
            ...
            let action = ToolbarAction(
                ...
                translationConfiguration: TranslationConfiguration(
                    canTranslate: canShowTranslateButton(),
                    hasTranslated: false
                ),
    ...
    private func handleToolbarButtonTapActions(action: ToolbarMiddlewareAction, state: AppState) {
        ...
        case .translate:
            ...
            let toolbarAction = ToolbarAction(
                translationConfiguration: TranslationConfiguration(canTranslate: true, hasTranslated: !isTranslateActive),
                windowUUID: action.windowUUID,
    ...
    private func canShowTranslateButton() -> Bool {
        return featureFlags.isFeatureEnabled(.translations, checking: .buildOnly)
    }
