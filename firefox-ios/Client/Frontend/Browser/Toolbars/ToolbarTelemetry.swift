...
struct ToolbarTelemetry {
    ...
    func clearSearchButtonTapped(isPrivate: Bool) {
        ...
        gleanWrapper.recordEvent(for: GleanMetrics.Toolbar.clearSearchButtonTapped, isPrivateExtra)
    }
    ...
    func siteInfoButtonTapped(isPrivate: Bool) {
        ...
        gleanWrapper.recordEvent(for: GleanMetrics.Toolbar.siteInfoButtonTapped, extras: isPrivateExtra)
    }
    ...
    func searchButtonTapped(isPrivate: Bool) {
        ...
        gleanWrapper.recordEvent(for: GleanMetrics.Toolbar.searchButtonTapped, isPrivateExtra)
    }
