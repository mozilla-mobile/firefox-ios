...
class RemoteTabsTableViewController: UITableViewController,
    ...
    override func tableView(_ tableView: UITableView,
        ...
        if editingStyle == .delete {
            ...
            self.resetFlushTabCommandsTimer(deviceId: fxaDeviceId)
        }
    }
    ...
    private func undo() {
        ...
        self.resetFlushTabCommandsTimer(deviceId: deviceId)
    }

    private func resetFlushTabCommandsTimer(deviceId: String) {
