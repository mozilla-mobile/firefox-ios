...
struct BrowserViewControllerState: ScreenState {
    ...
    static let modernReducer: ReducerMethod<Self> = { state, action, windowUUID in
        ...
        return BrowserViewControllerState(
            ...
            microsurveyState: MicrosurveyPromptState
                .reducer.modernReducer(state.microsurveyState, action, windowUUID),
            autoTranslatePromptState: AutoTranslatePromptState
                .reducer.modernReducer(state.autoTranslatePromptState, action, windowUUID),
        )
    }
    ...
    static let legacyReducer: LegacyReducerMethod<Self> = { state, action in
        ...
        if let action = action as? MicrosurveyPromptAction {
            ...
            return BrowserViewControllerState(
                ...
                browserViewType: state.browserViewType,
                microsurveyState: MicrosurveyPromptState
                                  .reducer.legacyReducer(state.microsurveyState, action),
                autoTranslatePromptState: AutoTranslatePromptState
