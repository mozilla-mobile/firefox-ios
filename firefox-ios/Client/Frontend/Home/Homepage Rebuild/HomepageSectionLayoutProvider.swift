...
final class HomepageSectionLayoutProvider {
    ...
    private func createLayoutSection(
        ...
        case .topSites:
            return createTopSitesSectionLayout(for: traitCollection, numberOfTilesPerRow: 4)
        case .pocket:
    ...
    func createTopSitesSectionLayout(
        ...
        section.contentInsets = NSDirectionalEdgeInsets(
            top: 0,
            leading: leadingInset,
            bottom: HomepageViewModel.UX.spacingBetweenSections - UX.interGroupSpacing, // investigate this more
            trailing: leadingInset
        )
