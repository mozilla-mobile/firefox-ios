...
extension OnboardingCardDelegate where Self: OnboardingViewControllerProtocol,
    ...
    func presentDefaultBrowserPopup(
        ...
        var bottomSheetViewModel = BottomSheetViewModel(closeButtonA11yLabel: .CloseButtonTitle, closeButtonA11yIdentifer: AccessibilityIdentifiers.Onboarding.bottomSheetCloseButton)
