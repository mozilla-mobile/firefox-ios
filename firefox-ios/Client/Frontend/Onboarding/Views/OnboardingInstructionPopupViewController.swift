...
class OnboardingInstructionPopupViewController: UIViewController,
    ...
    var viewModel: OnboardingInstructionsPopupInfoModel<OnboardingInstructionsPopupActions>
    ...
    // MARK: - Initializers
    init(viewModel: OnboardingInstructionsPopupInfoModel<OnboardingInstructionsPopupActions>,
