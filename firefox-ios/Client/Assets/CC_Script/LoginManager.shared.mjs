...
export class Logic {
  ...
  static isProbablyANewPasswordField(inputElement) {
    const inIframe =
      inputElement.ownerGlobal.location !==
      inputElement.ownerGlobal.parent.location;
  ...
  fillConfirmFieldWithGeneratedPassword(passwordField) {
    ...
    // TODO(issam): How much of this do we need on JS ?
    ...
    //   // TODO(issam): better logging support
