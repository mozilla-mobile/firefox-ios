...
protocol BrowserNavigationHandler: AnyObject, QRCodeNavigationHandler {
    ...
    /// Displays an autofill interface for saved logins, allowing the user to select from stored login credentials to autofill login forms on the specified web page.
