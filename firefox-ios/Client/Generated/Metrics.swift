...
extension GleanMetrics {
    class GleanBuild {
        ...
        public static let info = BuildInfo(buildDate: DateComponents(calendar: Calendar.current, timeZone: TimeZone(abbreviation: "UTC"), year: 2023, month: 11, day: 27, hour: 11, minute: 35, second: 26))
    }
    ...
    enum BaselineValidation {
        ...
        static let startupDuration = TimespanMetricType( // generated from baseline.validation.startup_duration
            CommonMetricData(
                category: "baseline.validation",
        ...
        static let visibleDuration = TimespanMetricType( // generated from baseline.validation.visible_duration
            CommonMetricData(
                category: "baseline.validation",
                name: "visible_duration",
                sendInPings: ["temp-baseline"],
                lifetime: .ping,
                disabled: false
            )
    ...
    enum Logins {
        ...
        /// Records when the Password autofill prompt was dismissed.
        ...
        /// Records when the Password autofill prompt was shown
        ...
        /// Records when a username and password pair was detected
        static let passwordDetected = EventMetricType<NoExtras>( // generated from logins.password_detected
            CommonMetricData(
                category: "logins",
    ...
    class Pings {
        ...
        enum TempBaselineReasonCodes: Int, ReasonCodes {
            case active = 0
            case dirtyStartup = 1
            case foreground = 2
            case inactive = 3
        ...
        let tempBaseline = Ping<TempBaselineReasonCodes>(
            name: "temp-baseline",
            includeClientId: true,
            sendIfEmpty: true,
            preciseTimestamps: true,
            reasonCodes: ["active", "dirty_startup", "foreground", "inactive"]
        )
