...
final class HomepageSearchBarTests: FeatureFlaggedTestBase {
    func test_homepageSearchBar_experimentOff_doesNotShowSearchBar() {
    ...
    func test_homepageSearchBar_experimentOn_switchFromTopToBottomToolbar_showsExpectedBehavior() {
    ...
    func test_homepageSearchBar_experimentOn_switchFromBottomToTopToolbar_showsExpectedBehavior() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
    ...
    func test_homepageSearchBar_fromPortraitToLandscape_showsOnlyInPortrait() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        let homepageSearchBar = app.collectionViews
    ...
    func test_tappingOnHomepageSearchBar_experimentOn_showsZeroSearchState() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        navigator.nowAt(NewTabScreen)
    ...
    func test_tappingOnSearchButton_forNavigationToolbar_experimentOn_showsZeroSearchState() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        navigator.nowAt(NewTabScreen)
    ...
    func test_openNewTabFromTabTray_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        navigator.nowAt(NewTabScreen)
    ...
    func test_openNewTabFromMenu_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        navigator.nowAt(NewTabScreen)
    ...
    func test_openNewTabFromLongPress_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        navigator.nowAt(NewTabScreen)
    ...
    func test_openNewTabFromNavigationToolbar_FromWebpage_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
    ...
    func test_openNewTabFromTabTray_FromWebpage_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        let homepageSearchBar = app.collectionViews
    ...
    func test_openNewTabFromMenu_FromWebpage_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        let homepageSearchBar = app.collectionViews
    ...
    func test_openNewTabFromLongPress_FromWebpage_experimentOn_hidesSearchBar() {
        addLaunchArgument(jsonFileName: "homepageSearchBarOn", featureName: "homepage-redesign-feature")
        app.launch()
        guard !iPad() else { return }
        let homepageSearchBar = app.collectionViews
