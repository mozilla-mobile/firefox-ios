...
func createScreenGraph(for test: XCTestCase, with app: XCUIApplication) -> MMScreenGraph<FxUserState> {
    ...
    map.addScreenState(BrowserTabMenu) { screenState in
        ...
        tapShareAppleImage(screenState)

        tapDeviceDesktopImage(screenState)
        tapDeviceMobileImage(screenState)
        tapSearchImage(screenState)
        tapPageZoomImage(screenState)
        // TODO: Add new state
//        screenState.tap(
...
//        )
    ...
    func tapSyncImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapLoginImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapDownloadImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapAvatarCircleImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapNightModeImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapWhatsNewImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapDeviceDesktopSendImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapDeviceDesktopImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapDeviceMobileImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapSearchImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapPinImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapLinkImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
    ...
    func tapReadingListAddImage(_ screenState: MMScreenStateNode<FxUserState>) {
        screenState.tap(
            app.tables.otherElements[StandardImageIdentifiers.Large.readingListAdd],
            forAction: Action.AddToReadingListBrowserTabMenu
        )
