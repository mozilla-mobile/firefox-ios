...
class BookmarksTests: BaseTestCase {
    ...
    func testBookmarksAwesomeBar() {
        ...
        app.textFields[AccessibilityIdentifiers.Browser.UrlBar.url].typeText(".com")
        app.textFields[AccessibilityIdentifiers.Browser.UrlBar.url].typeText("\r")
        navigator.nowAt(BrowserTab)
    ...
    private func typeOnSearchBar(text: String) {
        ...
        app.textFields[AccessibilityIdentifiers.Browser.UrlBar.url].typeText(text)
    }
