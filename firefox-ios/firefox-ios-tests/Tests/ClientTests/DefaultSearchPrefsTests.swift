...
class DefaultSearchPrefsTests: XCTestCase {
    func testParsing_hasAllInfo_succeeds() {
        ...
        let japan = (
            lang: ["ja-JP", "ja"],
            region: "JP",
            resultList: ["google-b-m", "amazon-jp", "bing", "ddg", "ebay", "wikipedia-ja", "yahoo-jp"],
            resultDefault: "Google"
        )
        let canada = (
            lang: ["en-CA", "en"],
        ...
        let russia = (
            lang: ["ru-RU", "ru"],
            region: "RU",
            resultList: ["google-com-nocodes", "ddg", "ebay", "wikipedia-ru"],
            resultDefault: "Google"
        )
        let taiwan = (
            lang: ["zh-TW", "zh"],
        ...
        let china = (
            ...
            region: "CN",
            resultList: ["google-b-m", "baidu", "bing", "ddg", "wikipedia-zh-CN"],
            resultDefault: "百度"
        )
        let germany = (
            lang: ["de-DE", "de"],
