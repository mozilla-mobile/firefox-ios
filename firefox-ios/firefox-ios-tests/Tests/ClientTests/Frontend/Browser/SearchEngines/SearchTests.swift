...
class SearchTests: XCTestCase {
    ...
    func testURIFixup() {
        ...
        checkValidURL("mailto:example@mozilla.org", afterFixup: "mailto:example@mozilla.org")
        ...
        checkValidURL("http://foo.bar/foo bar", afterFixup: "http://foo.bar/foo%20bar")
        ...
        checkInvalidURL("mozilla. org")
        checkInvalidURL("http://mozilla. org")
        checkInvalidURL("123")
        checkInvalidURL("a/b")
