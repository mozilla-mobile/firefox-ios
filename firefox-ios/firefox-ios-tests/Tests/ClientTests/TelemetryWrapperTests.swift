  ...
  func test_AwesomebarAbandonment_GleanIsCalled() {
    ...
    func testRecordToolbarWhenSearchTappedThenGleanIsCalled() {
        ...
        TelemetryWrapper.gleanRecordEvent(category: .action,
                                          method: .tap,
                                          object: .toolbar,
                                          value: .toolbarSearchButtonTap,
                                          extras: extras)
        testEventMetricRecordingSuccess(metric: GleanMetrics.Toolbar.searchButtonTapped)
    }

    func testRecordToolbarWhenTabTrayTappedThenGleanIsCalled() {
        let extras = [TelemetryWrapper.EventExtraKey.Toolbar.isPrivate.rawValue: true]
        TelemetryWrapper.gleanRecordEvent(category: .action,
                                          method: .tap,
                                          object: .toolbar,
                                          value: .toolbarTabTrayButtonTap,
                                          extras: extras)
        testEventMetricRecordingSuccess(metric: GleanMetrics.Toolbar.tabTrayButtonTapped)
    }

    func testRecordToolbarWhenTabTrayLongPressedThenGleanIsCalled() {
        let extras = [TelemetryWrapper.EventExtraKey.Toolbar.isPrivate.rawValue: true]
        TelemetryWrapper.gleanRecordEvent(category: .action,
                                          method: .tap,
                                          object: .toolbar,
                                          value: .toolbarTabTrayButtonLongPress,
                                          extras: extras)
    ...
    func testRecordToolbarWhenDataClearanceTappedThenGleanIsCalled() {
        let extras = [TelemetryWrapper.EventExtraKey.Toolbar.isPrivate.rawValue: true]
        TelemetryWrapper.gleanRecordEvent(category: .action,
                                          method: .tap,
                                          object: .toolbar,
                                          value: .toolbarDataClearanceButtonTap,
                                          extras: extras)
