...
extension ShareViewController {
    ...
    func actionSendToDevice(gesture: UIGestureRecognizer) {
        ...
        // If the returned vc is a navigation controller, push its root view controller.
        if let nav = vc as? UINavigationController, let rootVC = nav.viewControllers.first {
