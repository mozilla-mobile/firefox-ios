...
class ProfileTest: XCTestCase {
    ...
    func testShareItemAddsToDatabase() {
        ...
        let clients = [RemoteClient(guid: client1GUID, name: "Test client 1", modified: NSDate.now(), type: "mobile", formfactor: "largetablet", os: "iOS"),
...
//                XCTAssertEqual(clients.count, commands.count)
//                commands.map({ command -> SyncCommand in
//                    XCTAssertEqual(url, command.url!)
