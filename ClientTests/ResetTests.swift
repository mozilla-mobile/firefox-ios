...
class ResetTests: XCTestCase {
    func testResetting() {
        ...
        XCTAssertTrue(tabs.insertOrUpdateClient(RemoteClient(guid: "abcdefghijkl", name: "Remote", modified: Date.now(), type: "mobile", formfactor: "tablet", os: "Windows", version: "55.0.1")).value.isSuccess)
