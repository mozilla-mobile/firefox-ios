...
class DefaultSearchPrefsTests: XCTestCase {
    ...
    func testParsing() {
        ...
        let us = (lang: ["en-US", "en"], region: "US", resultList: ["google-2018", "yahoo", "bing", "amazondotcom", "ddg", "twitter", "wikipedia"], resultDefault: "Google")
        let england = (lang: ["en-GB", "en"], region: "GB", resultList: ["google", "yahoo-en-GB", "bing", "amazon-co-uk", "ddg", "qwant", "twitter", "wikipedia"], resultDefault: "Google")
        let france = (lang: ["fr-FR", "fr"], region: "FR", resultList: ["google", "yahoo-france", "bing", "ddg", "qwant", "twitter", "wikipedia-fr"], resultDefault: "Google")
        let japan = (lang: ["ja-JP", "ja"], region: "JP", resultList: ["google", "amazon-jp", "bing", "twitter-ja", "wikipedia-ja", "yahoo-jp"], resultDefault: "Google")
        let canada = (lang: ["en-CA", "en"], region: "CA", resultList: ["google", "yahoo", "bing", "amazondotcom", "ddg", "twitter", "wikipedia"], resultDefault: "Google")
        ...
        let germany = (lang: ["de-DE", "de"], region: "DE", resultList: ["google", "yahoo-de", "bing", "amazon-de", "ddg", "qwant", "twitter", "wikipedia-de"], resultDefault: "Google")
        let southAfrica = (lang: ["en-SA", "en"], region: "SA", resultList: ["google", "yahoo", "bing", "amazondotcom", "ddg", "twitter", "wikipedia"], resultDefault: "Google")
