...
open class ClientsSynchronizer: TimestampedSingleCollectionSynchronizer, Synchronizer {
    ...
    open func synchronizeLocalClients(_ localClients: RemoteClientsAndTabs, withServer storageClient: Sync15StorageClient, info: InfoCollections) -> Sync.SyncResult {
