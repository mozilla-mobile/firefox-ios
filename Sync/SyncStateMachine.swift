...
public class Scratchpad {
    ...
    let metaGlobal: GlobalEnvelope?       // Should this be unwrapped?
    ...
    init(b: KeyBundle, m: GlobalEnvelope?, i: InfoCollections?) {
        self.syncKeyBundle = b
        self.metaGlobal = m
    ...
    func withInfo(i: InfoCollections) -> Scratchpad {
        return Scratchpad(b: self.syncKeyBundle, m: self.metaGlobal, i: i)
    }
}
 ...
 * so we use function dispatch to ape a protocol.
 */
