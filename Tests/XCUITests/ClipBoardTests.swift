...
class ClipBoardTests: BaseTestCase {
    ...
    func testClipboardPasteAndGo() {
        ...
        waitForExistence(app.tables["Context Menu"].otherElements[ImageIdentifiers.Large.clipboard])
        app.tables["Context Menu"].otherElements[ImageIdentifiers.Large.clipboard].tap()
