...
class HawkHelper {
    ...
    func getAuthorizationValueFor(request: NSURLRequest, at timestampInSeconds: Int) -> String {
    ...
    func getAuthorizationValueFor(request: NSURLRequest, at timestampInSeconds: Int, nonce: String, extra: String) -> String {
