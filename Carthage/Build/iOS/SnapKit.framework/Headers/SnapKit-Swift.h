...
@property (nonatomic, readonly, copy) NSString * __nullable snp_makerFile;
@end
...
@property (nonatomic, copy) NSArray<LayoutConstraint *> * __nonnull snp_installedLayoutConstraints;
@end
