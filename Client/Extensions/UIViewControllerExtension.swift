...
extension UIViewController {
    ...
    func presentThemedViewController(navItemLocation: NavigationItemLocation, navItemText: NavigationItemText, vcBeingPresented: UIViewController, topTabsVisible: Bool) {
        ...
        presentDismissIfNeeded(viewController: themedNavigationController, animated: true)
    }
    ...
    /// currently presented.
    func presentDismissIfNeeded(viewController: UIViewController, animated: Bool) {
