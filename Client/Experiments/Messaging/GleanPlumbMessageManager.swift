...
class GleanPlumbMessageManager: GleanPlumbMessageManagerProtocol {
    ...
    private let helperUtility: GleanPlumbHelperUtilityProtocol
    ...
    init(
        helperUtility: GleanPlumbHelperUtilityProtocol = GleanPlumbHelperUtility(),
    ...
    func getNextMessage(for surface: MessageSurfaceId) -> GleanPlumbMessage? {
        ...
        guard let gleanPlumbHelper = helperUtility.createGleanPlumbHelper() else { return nil }
