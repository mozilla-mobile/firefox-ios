...
extension String {
    public static let NewPrivateTabButtonLabel = NSLocalizedString("TodayWidget.PrivateTabButtonLabelV1", tableName: "Today", value: "Private\nSearch", comment: "Open New Private Tab button label")
    public static let NewTabButtonLabel = NSLocalizedString("TodayWidget.NewTabButtonLabelV1", tableName: "Today", value: "New\nSearch", comment: "Open New Tab button label")
    public static let GoToCopiedLinkLabel = NSLocalizedString("TodayWidget.GoToCopiedLinkLabelV1", tableName: "Today", value: "Go to\ncopied link", comment: "Go to link pasted on the clipboard")
    public static let closePrivateTabsButtonLabel = NSLocalizedString("TodayWidget.ClosePrivateTabButtonLabelV1", tableName: "Today", value: "Close\nprivate tabs", comment: "Close Private Tabs button label")
