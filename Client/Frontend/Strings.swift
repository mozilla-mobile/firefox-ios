...
extension Strings {
    ...
    public static let EnableTPBlockingGlobally = NSLocalizedString("Menu.TrackingProtectionEnable1.Title", value: "Enable Tracking Protection", comment: "A button to enable tracking protection inside the menu.")
