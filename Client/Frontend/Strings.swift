    ...
    public struct FirefoxHomepage {
        ...
        public struct HomeTabBanner {
            public struct EvergreenMessage {
                ...
                public static let DefaultBrowserCloseAccessibility = MZLocalizedString("DefaultBrowserCloseButtonAccessibility.v102", value: "Close", comment: "Accessibility label for action denoting closing default browser card.", lastUpdated: .v102)
            }
        }
