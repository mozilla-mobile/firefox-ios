...
extension Strings {
    ...
    public static let AppMenuTabSentConfirmMessage = NSLocalizedString("Menu.AddBookmark.Confirm", value: "Tab Sent", comment: "Toast displayed to the user after a tab has been sent successfully.")
