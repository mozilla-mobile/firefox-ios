...
extension String {
    ...
    public static let DefaultBrowserCardButton = MZLocalizedString("DefaultBrowserCard.Button", tableName: "Default Browser", value: "Learn How", comment: "Button string to learn how to set your default browser.")
