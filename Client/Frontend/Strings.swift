...
extension String {
    ...
    public static let DefaultBrowserCardButton = MZLocalizedString("DefaultBrowserCard.Button", tableName: "Default Browser", value: "Go to Settings", comment: "Button string to open settings that allows user to switch their default browser to Firefox.")
