...
extension String {
    ...
    public static let NoOpenTabsLabelV2 = NSLocalizedString("TodayWidget.NoOpenTabsLabel", tableName: "Today", value: "No Open Tabs", comment: "Label that is shown when there are no tabs opened in tab tray i.e. Empty State")
    ...
    public static let QuickViewGalleryDescriptionV2 = NSLocalizedString("TodayWidget.QuickViewGalleryDescription", tableName: "Today", value: "Add shortcuts to your open tabs.", comment: "Description for Quick View widget in Gallery View where user can add it to home screen")
