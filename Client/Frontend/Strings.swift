    ...
    public struct Settings {
        ...
        public struct Homepage {
            ...
            public struct CustomizeFirefoxHome {
                ...
                public static let SponsoredPocket = MZLocalizedString("Settings.Home.Option.SponsoredPocket", value: "Sponsored by Pocket", comment: "In the settings menu, in the Firefox homepage customization section, this is the title for the option that allows users to turn the Pocket Recommendations section on the Firefox homepage on or off", lastUpdated: .v102)
