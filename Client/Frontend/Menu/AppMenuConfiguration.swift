...
extension AppMenuConfiguration {
    ...
    static let SharePageTitleString = NSLocalizedString("Menu.SharePageAction.Title", value: "Share", tableName: "Menu", comment: "String describing the action of invoking the share menu. On the menu")
