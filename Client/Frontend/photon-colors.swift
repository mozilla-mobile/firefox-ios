...
extension UIColor {
    struct Photon {
        static let LightGrey05 = UIColor(rgba: 0xfbfbfe)
        static let LightGrey10 = UIColor(rgba: 0xf9f9fb)
        static let LightGrey20 = UIColor(rgba: 0xf0f0f4)
        static let LightGrey30 = UIColor(rgba: 0xe0e0e6)
        static let LightGrey40 = UIColor(rgba: 0xcfcfd8)
        static let LightGrey50 = UIColor(rgba: 0xbfbfc9)
        static let LightGrey60 = UIColor(rgba: 0xafafba)
        static let LightGrey70 = UIColor(rgba: 0x9f9fad)
        static let LightGrey80 = UIColor(rgba: 0x8f8f9d)
        static let LightGrey90 = UIColor(rgba: 0x80808e)

        static let DarkGrey05 = UIColor(rgba: 0x5b5b66)
        static let DarkGrey10 = UIColor(rgba: 0x52525e)
        static let DarkGrey20 = UIColor(rgba: 0x4a4a55)
        static let DarkGrey30 = UIColor(rgba: 0x42414d)
        static let DarkGrey40 = UIColor(rgba: 0x3a3944)
        static let DarkGrey50 = UIColor(rgba: 0x32313c)
        static let DarkGrey60 = UIColor(rgba: 0x2b2a33)
        static let DarkGrey70 = UIColor(rgba: 0x23222b)
        static let DarkGrey80 = UIColor(rgba: 0x1c1b22)
        static let DarkGrey90 = UIColor(rgba: 0x15141a)

        static let Violet05 = UIColor(rgba: 0xe7dfff)
        static let Violet10 = UIColor(rgba: 0xd9bfff)
        static let Violet20 = UIColor(rgba: 0xcb9eff)
        static let Violet30 = UIColor(rgba: 0xc689ff)
        static let Violet40 = UIColor(rgba: 0xab71ff)
        static let Violet50 = UIColor(rgba: 0x9059ff)
        static let Violet60 = UIColor(rgba: 0x7542e5)
        static let Violet70 = UIColor(rgba: 0x592acb)
        static let Violet80 = UIColor(rgba: 0x45278d)
        static let Violet90 = UIColor(rgba: 0x321c64)
