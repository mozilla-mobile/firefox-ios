...
open class TabToolbarHelper: NSObject {
    ...
    init(toolbar: TabToolbarProtocol) {
        ...
        toolbar.appMenuButton.accessibilityLabel = .AppMenu.Toolbar.AppMenuButtonAccessibilityLabel
        ...
        toolbar.homeButton.accessibilityLabel = .AppMenu.Toolbar.AppMenuHomeMenuButtonAccessibilityLabel
        ...
        toolbar.bookmarksButton.accessibilityLabel = .AppMenu.Toolbar.AppMenuBookmarksButtonAccessibilityLabel
