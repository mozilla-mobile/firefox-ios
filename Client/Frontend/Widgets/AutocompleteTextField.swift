...
class AutocompleteTextField: UITextField, UITextFieldDelegate {
    ...
    private func normalizeString(_ string: String) -> String {
        return string.lowercaseString.stringByTrimmingLeadingCharactersInSet(CharacterSet.whitespaceCharacterSet())
    }
    ...
    private func applyCompletion() {
        if completionActive {
            if let text = text {
                self.attributedText = AttributedString(string: text)
                enteredText = text
            }
    ...
    private func removeCompletion() {
        if completionActive {
            ...
            attributedText = AttributedString(string: enteredText)
            completionActive = false
        }
    }
    ...
    private func removeCompletionIfRequiredForEnteredString(_ string: String) {
    ...
    func setAutocompleteSuggestion(_ suggestion: String?) {
        ...
        if let suggestion = suggestion where isEditing && canAutocomplete && markedTextRange == nil {
