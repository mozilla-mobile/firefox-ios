...
class ToggleButton: UIButton {
    ...
    fileprivate func updateMaskPathForSelectedState(_ selected: Bool) {
        ...
        if selected {
            var rect = CGRect(origin: .zero, size: UX.BackgroundSize)
    ...
    fileprivate func animateSelection(_ selected: Bool) {
        var endFrame = CGRect(origin: .zero, size: UX.BackgroundSize)
    ...
    override func layoutSubviews() {
        ...
        let zeroFrame = CGRect(origin: .zero, size: frame.size)
