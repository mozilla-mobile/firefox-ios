...
class BlurTableViewCell: UITableViewCell {
    lazy var titleLabel: UILabel = {
        ...
        titleLabel.textColor = BlurTableViewCellUX.LabelColor
    ...
    lazy var statusIcon: UIImageView = {
        ...
        siteImageView.layer.cornerRadius = BlurTableViewCellUX.CornerRadius
        return siteImageView
    }()

    lazy var selectedOverlay: UIView = {
        let selectedOverlay = UIView()
        selectedOverlay.backgroundColor = BlurTableViewCellUX.SelectedOverlayColor
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        statusIcon.snp_remakeConstraints { make in
            make.size.equalTo(BlurTableViewCellUX.StatusIconSize)
    ...
    func configureCell(label: String, imageString: String) {
        ...
        let image = UIImage(named: imageString)!.imageWithRenderingMode(.AlwaysTemplate)
