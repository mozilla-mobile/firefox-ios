...
signOutButton.setTitleColor(UIColor.whiteColor(), forState: UIControlState.Normal)
    ...
    func updateButton(maybeAccount: FirefoxAccount?) {
        if let account = maybeAccount {
            emailLabel.text = account.email
            signOutButton.setTitle(NSLocalizedString("Sign out", comment: ""), forState: UIControlState.Normal)
        } else {
            nameLabel.text = " "
            emailLabel.text = " "
            signOutButton.setTitle(NSLocalizedString("Sign in", comment: ""), forState: UIControlState.Normal)
        }
    }
