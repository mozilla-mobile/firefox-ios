...
private struct RemoteTabsPanelUX {
    ...
    static let EmptyStateInstructionsGetTabsBookmarksPasswordsString = NSLocalizedString("Get your tabs, bookmarks, and passwords from your other devices.", comment: "A re-worded offer about Sync that emphasizes one-way data transfer, not syncing.")
}
