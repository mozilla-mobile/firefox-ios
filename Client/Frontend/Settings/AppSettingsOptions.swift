...
class DefaultBrowserSetting: Setting {
    ...
    init(settings: SettingsTableViewController) {
        ...
        super.init(title: NSAttributedString(string: Strings.DefaultBrowserMenuItem, attributes: [NSAttributedString.Key.foregroundColor: UIColor.theme.tableView.rowText]))
    }
