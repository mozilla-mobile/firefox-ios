...
class TopTabCell: UICollectionViewCell {
    ...
    override func draw(_ rect: CGRect) {
        ...
        context.move(to: CGPoint(x: 0, y: TopTabsUX.BackgroundSeparatorLinePadding))
        context.addLine(to: CGPoint(x: 0, y: frame.size.height-TopTabsUX.BackgroundSeparatorLinePadding))
        context.strokePath()
