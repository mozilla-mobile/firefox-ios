...
// MARK: View Controller Callbacks
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(TabTrayController.dynamicFontChanged), name: NotificationDynamicFontChanged, object: nil)
    }
...
fileprivate class TabManagerDataSource: NSObject, UICollectionViewDataSource {
    ...
    @objc func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        tabCell.closeButton.tintColor = tab.isPrivate ? .white : .gray
        ...
        if let favIcon = tab.displayFavicon {
            ...
            if tab.isPrivate {
                ...
                tabCell.favicon.tintColor = .white
            } else {
                tabCell.favicon.image = defaultFavicon
            }
        }
