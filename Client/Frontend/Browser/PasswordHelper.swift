...
private let SaveButtonTitle = NSLocalizedString("Save", comment: "Save password button")
private let NotNowButtonTitle = NSLocalizedString("Not now", comment: "Do not save password button")
private let UpdateButtonTitle = NSLocalizedString("Update", comment: "Update password button")
...
class PasswordHelper: BrowserHelper {
    ...
    private func promptSave(password: Password) {
        let promptPreLocalized = NSLocalizedString("Do you want to save the password for %@ on %@?", comment: "Prompt for saving a password. The first parameter is the username being saved. The second parameter is the hostname of the site.")
        let promptMessage = NSAttributedString(string: String(format: promptPreLocalized, password.username, password.hostname))
    ...
    private func promptUpdate(password: Password) {
        let promptPreLocalized = NSLocalizedString("Do you want to update the password for %@ on %@?", comment: "Prompt for updating a password. The first parameter is the username being saved. The second parameter is the hostname of the site.")
        let promptMessage = NSAttributedString(string: String(format: promptPreLocalized, password.username, password.hostname))
