...
class SearchEngines {
    ...
    fileprivate var disabledEngineNames: [String: Bool]! {
        didSet {
            self.prefs.setObject(Array(self.disabledEngineNames.keys) as AnyObject?, forKey: DisabledEngineNames)
        }
    }
    ...
    var shouldShowSearchSuggestionsOptIn: Bool {
        didSet {
            self.prefs.setObject(shouldShowSearchSuggestionsOptIn as AnyObject?, forKey: ShowSearchSuggestionsOptIn)
        }
    }

    var shouldShowSearchSuggestions: Bool {
        didSet {
            self.prefs.setObject(shouldShowSearchSuggestions as AnyObject?, forKey: ShowSearchSuggestions)
        }
    }
