...
//    private var animator: Animator?
    var deferredHitTest: (Int, CGFloat, CGFloat, ResultArrayBlock)? = nil
    var timerSessionRunningInBackground: Timer?
    ...
    func createWebview() {
        if webView == nil {
            ...
            #if WEBXR
                let tmpView = setupWebXRWebView()
                guard let webView = tmpView else {
