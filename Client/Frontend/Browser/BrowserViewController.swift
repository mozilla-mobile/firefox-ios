...
class BrowserViewController: UIViewController {
    ...
    let topTabsContainer = UIView(frame: .zero)
    ...
    override func viewDidLoad() {
        ...
        webViewContainerBackdrop.backgroundColor = .gray
        ...
        snackBars.backgroundColor = .clear
        ...
        Alamofire.request(url)
            ...
            .response { response in
                if let data = response.data,
                   let image = data.isGif ? UIImage.imageFromGIFDataThreadSafe(data) : UIImage.imageFromDataThreadSafe(data) {
                    success(image)
                }
            }
    }
...
extension BrowserViewController {
    ...
    func addCustomSearchButtonToWebView(_ webView: WKWebView) {
        ...
        if !matches.isEmpty {
            self.customSearchEngineButton.tintColor = .gray
