    ...
    override var keyCommands: [UIKeyCommand]? {
        if #available(iOS 9.0, *) {
            return [
                ...
                UIKeyCommand(input: UIKeyInputRightArrow, modifierFlags: .Command, action: #selector(BrowserViewController.nextTab), discoverabilityTitle: Strings.ShowNextTabTitle),
                ...
                UIKeyCommand(input: UIKeyInputLeftArrow, modifierFlags: .Command, action: #selector(BrowserViewController.previousTab), discoverabilityTitle: Strings.ShowPreviousTabTitle),
            ]
        } else {
            ...
            return [
                ...
                UIKeyCommand(input: "]", modifierFlags: .Command, action: #selector(BrowserViewController.goForward)),
