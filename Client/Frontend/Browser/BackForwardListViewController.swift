...
class BackForwardListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let doneItem = UIBarButtonItem(title: NSLocalizedString("Done", comment: "Done title in back forward list screen"), style: .Done, target: self, action: "SELdidClickDone")
