...
class WebExtensionStorageAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "storage" }
...
extension WebExtensionStorageAPI: WebExtensionAPIConnectionHandler {
