...
class WebExtensionThemeAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "theme" }
...
extension WebExtensionThemeAPI: WebExtensionAPIConnectionHandler {
