...
class WebExtensionIdentityAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "identity" }
...
extension WebExtensionIdentityAPI: WebExtensionAPIConnectionHandler {
