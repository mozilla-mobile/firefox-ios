...
class WebExtensionProxyAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "proxy" }
...
extension WebExtensionProxyAPI: WebExtensionAPIConnectionHandler {
