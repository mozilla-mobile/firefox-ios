...
class WebExtensionWebNavigationAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "webNavigation" }
...
extension WebExtensionWebNavigationAPI: WebExtensionAPIConnectionHandler {
