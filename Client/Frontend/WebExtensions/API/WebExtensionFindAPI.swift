...
class WebExtensionFindAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "find" }
...
extension WebExtensionFindAPI: WebExtensionAPIConnectionHandler {
