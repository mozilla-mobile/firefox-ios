...
class WebExtensionIdleAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "idle" }
...
extension WebExtensionIdleAPI: WebExtensionAPIConnectionHandler {
