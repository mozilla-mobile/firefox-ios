...
class WebExtensionDNSAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "dns" }
...
extension WebExtensionDNSAPI: WebExtensionAPIConnectionHandler {
