...
class WebExtensionPermissionsAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "permissions" }
...
extension WebExtensionPermissionsAPI: WebExtensionAPIConnectionHandler {
