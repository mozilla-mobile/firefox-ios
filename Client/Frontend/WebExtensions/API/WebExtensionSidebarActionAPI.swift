...
class WebExtensionSidebarActionAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "sidebarAction" }
...
extension WebExtensionSidebarActionAPI: WebExtensionAPIConnectionHandler {
