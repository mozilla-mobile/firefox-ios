...
class WebExtensionContentScriptsAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "contentScripts" }
...
extension WebExtensionContentScriptsAPI: WebExtensionAPIConnectionHandler {
