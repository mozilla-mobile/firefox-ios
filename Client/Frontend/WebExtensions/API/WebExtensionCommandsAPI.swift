...
class WebExtensionCommandsAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "commands" }
...
extension WebExtensionCommandsAPI: WebExtensionAPIConnectionHandler {
