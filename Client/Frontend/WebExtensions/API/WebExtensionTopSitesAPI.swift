...
class WebExtensionTopSitesAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "topSites" }
...
extension WebExtensionTopSitesAPI: WebExtensionAPIConnectionHandler {
