...
class WebExtensionPrivacyAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "privacy" }
...
extension WebExtensionPrivacyAPI: WebExtensionAPIConnectionHandler {
