...
class WebExtensionClipboardAPI: WebExtensionAPIEventDispatcher {
    override class var Name: String { return "clipboard" }
...
extension WebExtensionClipboardAPI: WebExtensionAPIConnectionHandler {
