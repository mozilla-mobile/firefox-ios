...
struct ReaderModeHandlers {
    ...
    static func register(_ webServer: WebServer, profile: Profile) {
        ...
        webServer.registerMainBundleResources(ofType: "ttf", module: "reader-mode/fonts")
        ...
        webServer.registerHandler(forMethod: "GET", module: "reader-mode", resource: "page-exists") { (request: GCDWebServerRequest!) -> GCDWebServerResponse! in
        ...
        webServer.registerHandler(forMethod: "GET", module: "reader-mode", resource: "page") { (request: GCDWebServerRequest!) -> GCDWebServerResponse! in
            if let url = request.query["url"] as? String {
                if let url = URL(string: url) where url.isWebPage() {
                    do {
                        ...
                        if let readerViewLoadingPath = Bundle.main.pathForResource("ReaderViewLoading", ofType: "html") {
                            do {
