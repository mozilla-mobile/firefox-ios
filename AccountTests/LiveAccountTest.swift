...
public class LiveAccountTest: XCTestCase {
    ...
    public func getAuthState(now: UInt64) -> Deferred<Result<SyncAuthState>> {
    ...
    public func syncAuthState(now: UInt64) -> Deferred<Result<(token: TokenServerToken, forKey: NSData)>> {
