...
class TrackingProtectionTests: KIFTestCase {
    ...
    func testNormalTrackingProtection() {
        openTPSetting()
        EarlGrey.select(elementWithMatcher: grey_accessibilityID("Settings.TrackingProtectionOption.OnInPrivateBrowsingLabel")).perform(grey_tap())
        closeTPSetting()
        ...
        openTPSetting()
        EarlGrey.select(elementWithMatcher: grey_accessibilityID("Settings.TrackingProtectionOption.OnLabel")).perform(grey_tap())
        closeTPSetting()
