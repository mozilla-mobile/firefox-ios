...
class LatestDevFirefoxAccountConfiguration: FirefoxAccountConfiguration {
    ...
    let signInURL = NSURL(string: "https://latest.dev.lcip.org/signin?context=fx_desktop_v1")!
    let settingsURL = NSURL(string: "https://latest.dev.lcip.org/settings?context=fx_desktop_v1")!
    let forceAuthURL = NSURL(string: "https://latest.dev.lcip.org/force_auth?context=fx_desktop_v1")!
}
...
class StableDevFirefoxAccountConfiguration: FirefoxAccountConfiguration {
    ...
    let signInURL = NSURL(string: "https://stable.dev.lcip.org/signin?context=fx_desktop_v1")!
    let settingsURL = NSURL(string: "https://stable.dev.lcip.org/settings?context=fx_desktop_v1")!
    let forceAuthURL = NSURL(string: "https://stable.dev.lcip.org/force_auth?context=fx_desktop_v1")!
}
...
class ProductionFirefoxAccountConfiguration: FirefoxAccountConfiguration {
    ...
    let signInURL = NSURL(string: "https://accounts.firefox.com/signin?context=fx_desktop_v1")!
    let settingsURL = NSURL(string: "https://accounts.firefox.com/settings?context=fx_desktop_v1")!
    let forceAuthURL = NSURL(string: "https://accounts.firefox.com/force_auth?context=fx_desktop_v1")!
}
