...
public class NSUserDefaultsPrefs: Prefs {
    ...
    public func branch(_ branch: String) -> Prefs {
    ...
    private func qualifyKey(_ key: String) -> String {
        return self.prefixWithDot + key
    }

    public func setInt(_ value: Int32, forKey defaultName: String) {
    ...
    public func setTimestamp(_ value: Timestamp, forKey defaultName: String) {
        setLong(value, forKey: defaultName)
    }

    public func setLong(_ value: UInt64, forKey defaultName: String) {
        setObject(NSNumber(value: value), forKey: defaultName)
    }

    public func setLong(_ value: Int64, forKey defaultName: String) {
        setObject(NSNumber(value: value), forKey: defaultName)
    }
    ...
    private func nsNumberForKey(_ defaultName: String) -> NSNumber? {
        return userDefaults.object(forKey: qualifyKey(defaultName)) as? NSNumber
    }

    public func unsignedLongForKey(_ defaultName: String) -> UInt64? {
        return nsNumberForKey(defaultName)?.uint64Value
    }

    public func timestampForKey(_ defaultName: String) -> Timestamp? {
        return unsignedLongForKey(defaultName)
    }

    public func longForKey(_ defaultName: String) -> Int64? {
        return nsNumberForKey(defaultName)?.int64Value
    }

    public func objectForKey<T: AnyObject>(_ defaultName: String) -> T? {
        return userDefaults.object(forKey: qualifyKey(defaultName)) as? T
    }

    public func intForKey(_ defaultName: String) -> Int32? {
