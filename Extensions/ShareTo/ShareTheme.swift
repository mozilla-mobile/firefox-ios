...
struct ShareTheme {
    ...
    static let textColor = ModernColor(dark: UIColor.Photon.DarkGrey90, light: UIColor.Photon.LightGrey05)
    static let iconColor = ModernColor(dark: UIColor.Photon.DarkGrey90, light: UIColor.Photon.LightGrey05)
}
