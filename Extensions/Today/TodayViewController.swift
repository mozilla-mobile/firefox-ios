...
class TodayViewController: UIViewController, NCWidgetProviding {
    ...
    private lazy var newTabLabel: UILabel = {
        return self.createButtonLabel(NSLocalizedString("New Tab", comment: "New Tab button label"))
    }()

    private lazy var newPrivateTabLabel: UILabel = {
        return self.createButtonLabel(NSLocalizedString("New Private Tab", comment: "New Private Tab button label"), color: privateBrowsingColor)
    }()
    ...
    private lazy var openURLFromClipboardView: UIView = {
        let view = UIView()
        let button = UIButton()
        button.setTitle(NSLocalizedString("Open URL from Clipboard", comment: "Open URL from clipboard label"), forState: .Normal)
