...
class TodayViewController: UIViewController, NCWidgetProviding {
    ...
    fileprivate lazy var newTabButton: ImageButtonWithLabel = {
        ...
        button.setImage(UIImage(named: "new_tab_button_normal")?.withRenderingMode(.alwaysTemplate), for: UIControlState())
    ...
    fileprivate lazy var openCopiedLinkButton: ButtonWithSublabel = {
        ...
        button.setTitle(TodayStrings.GoToCopiedLinkLabel, for: UIControlState())
        ...
        button.setImage(UIImage(named: "copy_link_icon")?.withRenderingMode(.alwaysTemplate), for: UIControlState())
    ...
    fileprivate func openContainingApp(_ urlSuffix: String = "") {
        ...
        self.extensionContext?.openURL(URL(string: urlString)!) { success in
